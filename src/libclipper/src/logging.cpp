...
void Logger::pad_logging_stream_for_alignment(std::stringstream &ss, LogLevel log_level,
  ...
  switch (log_level) {
    ...
    case LogLevel::Error: log_padding = LOGGING_LEVEL_FORMAT_ERROR_LENGTH; break;
    case LogLevel::Debug: log_padding = LOGGING_LEVEL_FORMAT_DEBUG_LENGTH; break;
    default: break;
  }
