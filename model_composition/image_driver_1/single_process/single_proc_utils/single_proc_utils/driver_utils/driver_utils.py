...
def save_results(configs, client_metrics, results_dir, process_num, arrival_process_file=None):
    """
    Parameters
    ----------
    ...
    if arrival_process_file:
        results_obj["arrival_process"] = arrival_process_file
