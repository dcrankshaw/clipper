...
if __name__ == "__main__":
    ...
    for inception_batch_size in [1, 5]:
        for inception_reps in range(1, 9):
            ...
            fname = "inception_{}".format(inception_reps)
            driver_utils.save_results(configs, cl, all_stats,
                                    "just_inception_batch_size_{}".format(inception_batch_size),
                                    prefix=fname)
