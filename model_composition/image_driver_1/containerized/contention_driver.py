...
if __name__ == "__main__":
    ...
    contention_reps = [(1, 1, 1, 1)]


    ## FORMAT IS (INCEPTION, LOG REG, RESNET, KSVM)
    contention_batches = (1, 1, 1, 1)

    contention_latency_upper_bound = .4
    ...
    for inception_reps, log_reg_reps, resnet_reps, ksvm_reps in contention_reps:
        ...
        benchmarker = DriverBenchmarker(configs, queue, client_num, contention_latency_upper_bound)
