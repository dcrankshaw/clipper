...
def get_contention_configs(available_cpus, available_gpus, contention_gpu_batch, contention_cpu_batch):
    ...
    configs.append(driver_utils.HeavyNodeConfig(
        ...
        cpus_per_replica=1,
        gpus=available_gpus,
        batch_size=contention_gpu_batch,
        ...
        for batch_size in [16]:
            for contention_gpu_batch in [1, 4, 8, 32, 64]:
                ...
                with open(local_path, "r") as kd:
                    ...
                    # partially written
                    lines_to_remove = int(7*trial_length / batch_size)
