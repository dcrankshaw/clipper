...
time docker build -t model-comp/inception -f InceptionClassificationDockerfile ./
time docker build -t model-comp/opencv-feats -f OpenCvFeaturizationDockerfile ./
time docker build -t model-comp/opencv-svm -f OpenCvSvmDockerfile ./